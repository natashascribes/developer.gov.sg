...
category: Design
redirect_from: /products/categories/design/singapore-government-design-system/
...
The [SingapoRediscover Vouchers](https://singaporediscovers.life.gov.sg/){:target="_blank"} website and the [Singapore Government Developer Portal](https://www.developer.tech.gov.sg/){:target="_blank"} teams made use of SGDS when launching their websites. The teams were able to use SGDS’ ready-made components and framework, rather than starting from scratch, which saved them valuable time.
